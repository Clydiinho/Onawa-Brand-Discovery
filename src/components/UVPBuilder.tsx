...
export const UVPBuilder: React.FC<UVPBuilderProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="p-6 bg-slate-900/90 rounded-2xl border border-slate-800 shadow-xl flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-slate-300 flex items-center justify-between">
              ...
              <span className="text-[10px] text-slate-500">e.g., "AI CRM platform"</span>
            </label>
            <input
              type="text"
              value={uvp.offering}
              ...
              className="w-full px-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-200 focus:outline-none focus:border-amber-500/80 transition-all"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-slate-300 flex items-center justify-between">
              ...
              <span className="text-[10px] text-slate-500">e.g., "sales automation tool"</span>
            </label>
            <input
              type="text"
              value={uvp.category}
          ...
          <div className="flex flex-col gap-1.5 md:col-span-2">
            <label className="text-xs font-semibold text-slate-300 flex items-center justify-between">
              ...
              <span className="text-[10px] text-slate-500">e.g., "eliminates 80% of manual reporting"</span>
            </label>
            <input
              type="text"
              value={uvp.benefit}
            ...
            {goldenCircle.how && (
              <div className="flex items-center gap-2 mt-1 text-[11px]">
                <span className="text-slate-500">From Golden Circle 'How':</span>
                <button
                  type="button"
          ...
          <div className="flex flex-col gap-1.5 md:col-span-2">
            <label className="text-xs font-semibold text-slate-300 flex items-center justify-between">
              ...
              <span className="text-[10px] text-slate-500">e.g., "growth-stage B2B marketing leaders"</span>
            </label>
            <input
              type="text"
      ...
      <div className="p-6 bg-gradient-to-br from-amber-500/10 via-slate-900 to-purple-500/10 rounded-2xl border border-amber-500/30 shadow-2xl flex flex-col gap-4 relative">
        ...
        <blockquote className="text-lg md:text-xl font-serif italic text-slate-100 font-semibold leading-relaxed border-l-4 border-amber-400 pl-4 py-1">
          "{fullStatement}"
        </blockquote>
      </div>
    </div>
